...
public class HolonomicPathGenerator extends PathGenerator{
    ...
    double cruiseVelocity, double targetAcceleration, double[] angleEndpoints, double targetAngularAcceleration){
        ...
        TrapezoidalProfiler orientationProfile = new TrapezoidalProfiler(angleEndpoints, targetAngularAcceleration, path);
        orientationProfile.FillAngles(path);
